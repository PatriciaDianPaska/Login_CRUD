...
<h2 style=" margin-left: 10px; text-align:center;">Data Pelanggan</h2>

</div>
<!-- Basic Table -->
<div class="row clearfix" style="color: black; margin-top: 25px; ">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1000px; margin-left:100px; ">
    <div class="card">
        <div class="header">
            <?php 
