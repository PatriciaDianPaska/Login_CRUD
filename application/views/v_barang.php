        ...
        <div class="header">
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-6">
                 -->
                <h1 class=" " style=" margin-left: 3px; text-align:center;">Barang</h1>
            ...
            <div class="body">
            <div class="row"> -->
            <center><a style="margin: 35px; margin-left: 1px;" href="#tambah" class="btn btn-primary" data-toggle="modal"><span class="glyphicon-plus"></span>Tambah</a>
                <table style="color: #000; width:1000px; margin-left:75px; "  class="table table-hover table-striped">
                <tr>
    ...
    <div class="modal fade" id="tambah">
        <div class="modal-dialog">
             <div class="modal-content">
                ...
                <center><button type="button" class="close" data-dismiss="modal"><span ariahidden="true">&times;
                </span><span class="sr-only">Close</span></button>
                <h4 class="modal-title" style="margin-left:center">Tambah Barang</h4>
                </div>
